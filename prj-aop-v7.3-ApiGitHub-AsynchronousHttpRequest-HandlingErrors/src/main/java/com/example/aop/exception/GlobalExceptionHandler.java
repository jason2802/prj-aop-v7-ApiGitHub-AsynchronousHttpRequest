...
public class GlobalExceptionHandler {
    ...
    public final ResponseEntity<ApiError> handleException(Exception ex, WebRequest request) {
        ...
        if (ex instanceof UserNotFoundException) {
            ...
            return handleHttpClientException(hcee, headers, status, request);
        } else {
    ...
    protected ResponseEntity<ApiError> handleHttpClientException(HttpClientErrorException ex,
            HttpHeaders headers, 
            HttpStatus status,
            WebRequest request) {
		...
		// Qua decido di inserire il status code del messaggio di errore dell'api github e non il olito HTTPSTATUS.BAD_REQUEST
		return handleExceptionInternal(ex, new ApiError(errors), headers, ex.getStatusCode(), request);
